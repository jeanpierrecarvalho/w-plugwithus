...
const BlogPage: NextPage<IProps> = ({ posts }) => {
	return (
		<AnimatePage>
			<SeoHead
				title="Software Engineering Blog by Jean-Pierre Carvalho"
				description="I try to make an effort to document my journey as a software architect & software developer in the form of blog posts. Here you find some of the articles I published over the years."
			/>
			<Container>
